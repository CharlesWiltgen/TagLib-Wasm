...
| ------------------- | :--: | :--------: | :----: | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `getFormat`         |  ✓   |     ✓      |   ✓    | format-detection, id3-format-detection (`forEachBackend`); ogg-flavor-parity (Vorbis/FLAC/Speex/Opus all four Ogg flavours); format-detection niche nine (uat8) |
