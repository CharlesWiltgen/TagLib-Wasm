...
// metadata: a save directive (_stripId3), a chapter-save hint carried with
// chapters (_mp4ChapterStyle), and read-only info (id3Tags). Everything else is
// reconstructable state the registry must carry.
const CONTROL_KEYS = new Set(["_mp4ChapterStyle", "id3Tags", "_stripId3"]);
